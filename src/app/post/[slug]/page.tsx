...
export async function generateMetadata(
  ...
  const postUrl = `${config.baseUrl}/post/${result.post.slug}`;
  return {
    ...
    openGraph: {
      ...
      url: postUrl,
      type: "article",
      publishedTime: toISOString(result.post.publishedAt),
      modifiedTime: toISOString(result.post.updatedAt),
      authors: [result.post.author.name || "Subham Mahapatra"],
    },
    twitter: {
